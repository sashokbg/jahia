...
;(function($){
	$.movingBoxes = function(el, options){
		...
		/*	base.$left = base.$wrap.find('.mb-left').mouseenter(function(){
				base.goBack();
				return false;
			});	*/
			
			/*base.$right = base.$wrap.find('.mb-right').mouseenter(function(){
				base.goForward();
				return false;
			});*/
		...
		base.buildNav = function() {
			if (base.$nav) {
				...
				base.$nav.after("<a class='lienVoirTousMembres' href='#'>Voir tous les membres</a>");
			}
			if (o.buildNav && base.totalPanels > 1) {
				var t, j, a = '', $a;
				base.$panels.filter(':not(.cloned)').each(function(i){
					j = i + 1;
					a = '<span class="mb-link mb-panel' + j + '" href="#"></span>';
					$a = $(a);
				...
				base.$nav
					.find('span.mb-link').bind('click', function() {
