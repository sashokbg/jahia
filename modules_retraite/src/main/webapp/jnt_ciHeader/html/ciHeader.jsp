...
<c:if test="${not renderContext.editMode}">
	<%@ include file="../../common/google_analytics_init.jspf"%>
	<%@ include file="../../common/loi_cookie.jspf"%>
...
<div class="headerTopContainer">
	...
	<c:choose> 
		...
		<c:when test="${connected}">
			<%@include file="ciHeader_badge_connected.jspf" %>
		</c:when>		
		<%-- Not connected --%>	
		<c:otherwise>
			<%@ include file="ciHeader_badge_notConnected.jspf"%>	
		</c:otherwise>
	</c:choose>
