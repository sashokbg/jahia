...
public class KFPostedRepliesFR extends AbstractStatCallback {

	private final transient static Logger LOGGER = org.slf4j.LoggerFactory.getLogger(KFPostedRepliesFR.class);
					...
					if (userProperty != null) {
						...
						if (node != null) {
							...
							if (!isModo
									...
									&& USER_TYPE_FUTUR_RETRAITE.equals(replyUser.getProperty("userType").getString())) {
								size++;
							}
						}
					}
