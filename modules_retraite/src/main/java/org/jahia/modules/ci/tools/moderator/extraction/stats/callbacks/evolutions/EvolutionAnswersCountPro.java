...
public class EvolutionAnswersCountPro extends AbstractStatCallback {

	private final transient static Logger LOGGER = org.slf4j.LoggerFactory.getLogger(EvolutionAnswersCountPro.class);
	...
	public Object getData(JCRSessionWrapper session, RenderContext context) {
		...
		if (nodes != null) {
			List<String> userUuids = getProfessionalsUuids(session, context);
			while (nodes.hasNext()) {
