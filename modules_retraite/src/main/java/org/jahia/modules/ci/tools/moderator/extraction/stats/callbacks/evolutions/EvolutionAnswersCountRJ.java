...
public class EvolutionAnswersCountRJ extends AbstractStatCallback {

	private final transient static Logger LOGGER = org.slf4j.LoggerFactory.getLogger(EvolutionAnswersCountRJ.class);
	...
	public Object getData(JCRSessionWrapper session, RenderContext context) {
		...
		if (nodes != null) {
			List<String> userUuids = getMembersUuids(session, context, USER_TYPE_RETRAITE_JUNIOR, MEMBER_WHATEVER_THE_LOCK);
			while (nodes.hasNext()) {
