...
public class Validator {
	...
	/**
	 * Returns <code>true</code> if the string is not <code>empty</code>, meaning
	 * it is not a <code>empty</code> reference, nothing but spaces, or the
	 * string "<code>empty</code>".
	 *
	 * @param  s the string to check
	 * @return <code>true</code> if the string is not <code>empty</code>;
	 *         <code>false</code> otherwise
	 */
